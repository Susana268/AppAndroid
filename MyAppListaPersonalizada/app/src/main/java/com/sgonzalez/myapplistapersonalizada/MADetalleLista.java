...
public class MADetalleLista extends AppCompatActivity {
    ...
    private void llenarLista(){
        ...
        switch (obtenerDatos()){
            case "Pedro":
                secundario = new AdapterPersonalizadoSecundario(this,
                        R.layout.lista_personalizada_secundaria,
                        imagesFamiliarPedro(),nombreFamiliarPedro(),apellidoFamiliarPedro(),
                        edadFamiliarPedro());
            ...
            case "Karla":
                secundario = new AdapterPersonalizadoSecundario(this,
                        R.layout.lista_personalizada_secundaria,
                        imagesFamiliarKarla(),nombreFamiliarKarla(),apellidoFamiliarKarla(),
                        edadFamiliarKarla());
                listView.setAdapter(secundario);
                break;
            default:
    ...
    private ArrayList<Integer> imagesFamiliarPedro(){
    ...
    private ArrayList<Integer> imagesFamiliarKarla(){
        ArrayList<Integer> images = new ArrayList<>();
        images.add(R.drawable.ic_user);
        images.add(R.drawable.ic_launcher_foreground);
        images.add(R.drawable.ic_user);
