...
public class MADetalle extends AppCompatActivity {
    ...
    private void obtenerDatos(){
        ...
        String codigo = String.valueOf(  bundle.getInt("codigo") );
        String nombre = bundle.getString("nombre");
        String sabor =  bundle.getString("sabor");
        String presentacion= String.valueOf( bundle.getInt("presentacion") );
        String tipo = bundle.getString("tipo");
        String precio = String.valueOf(bundle.getDouble("precio"));
        trasladarFragmento(codigo,nombre,sabor,presentacion,tipo,precio);
    }

    private void trasladarFragmento(String codigo,String nombre,String sabor,String presentacion,
