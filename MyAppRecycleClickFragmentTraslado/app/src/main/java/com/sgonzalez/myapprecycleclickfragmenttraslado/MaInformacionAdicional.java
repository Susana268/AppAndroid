...
public class MaInformacionAdicional extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getData();
        this.obtenerYTrasladarInformacoinAdicional();

        this.navegacionTabLayount();
    }

    private void navegacionTabLayount(){
    ...
    private void obtenerYTrasladarInformacoinAdicional(){
        Bundle bundle = getIntent().getExtras();
