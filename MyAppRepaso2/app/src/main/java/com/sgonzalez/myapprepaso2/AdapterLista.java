package com.sgonzalez.myapprepaso2;
...
public class AdapterLista extends BaseAdapter {
    ...
    public AdapterLista(Context context,Integer referenciaLista,
                        ArrayList<String> nombreGenero,
                        ArrayList<Integer> imgGenero){
